...
import com.yoho.glide.util.DisplayUtil;

import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;
import com.yoho.glide.R;
/**
 * Created by zhugongzhao on 2017/6/12.
 */
public class ShapeImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            borderWidth = array.getDimensionPixelOffset(R.styleable.ShapeImageView_border_width, borderWidth);
            borderColor = array.getColor(R.styleable.ShapeImageView_border_color, borderColor);
            radius = array.getDimensionPixelOffset(R.styleable.ShapeImageView_radius, radius);
            pressedAlpha = array.getFloat(R.styleable.ShapeImageView_pressed_alpha, pressedAlpha);
            if (pressedAlpha > 1) pressedAlpha = 1;
            pressedColor = array.getColor(R.styleable.ShapeImageView_pressed_color, pressedColor);
            shapeType = array.getInteger(R.styleable.ShapeImageView_shape_type, shapeType);
            array.recycle();
        }
