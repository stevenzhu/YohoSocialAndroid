...
import social.iyoho.com.imgselectlibrary.widget.PreviewViewPager;
...
public class ImagePreviewActivity extends AppCompatActivity {
    ...
    public static void startPreview(Fragment fragment, List<LocalMedia> images, List<LocalMedia> selectImages, int maxSelectNum, int position) {
        Intent intent = new Intent(fragment.getActivity(), ImagePreviewActivity.class);
        intent.putExtra(EXTRA_PREVIEW_LIST, (ArrayList) images);
        intent.putExtra(EXTRA_PREVIEW_SELECT_LIST, (ArrayList) selectImages);
        intent.putExtra(EXTRA_POSITION, position);
        intent.putExtra(EXTRA_MAX_SELECT_NUM, maxSelectNum);
        fragment.startActivityForResult(intent, REQUEST_PREVIEW);
    }
    ...
    public void initView() {
        ...
        navigationTextView.setText((position + 1) + "/" + images.size());
        ...
        checkboxSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectImages.size() >= maxSelectNum && isChecked) {
                    Toast.makeText(ImagePreviewActivity.this, getString(R.string.message_max_num), Toast.LENGTH_LONG).show();
